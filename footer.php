...
<footer class="footer">
  <div class="container footer__container">
    <a data-fancybox href="#term-of-service" data-options='{"touch" : false}'>Terms of Service</a>
    <a data-fancybox href="#refund-policy" data-options='{"touch" : false}'>Refund Policy</a>
    <a data-fancybox href="#privacy-policy" data-options='{"touch" : false}'>Privacy Policy</a>
...
<div style="display: none;" class="modal modal-content" id="refund-policy">
  ...
  <?php
    ...
    ?>
      ...
      <!-- Swiper -->
      <div class="swiper scroll-container refundSwiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <?php echo $post->post_content ?>
          </div>
...
<div style="display: none;" class="modal modal-content" id="privacy-policy">
  ...
  <?php
    ...
    ?>
      ...
      <!-- Swiper -->
      <div class="swiper scroll-container privacySwiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <?php echo $post->post_content ?>
          </div>
...
<div style="display: none;" class="modal modal-order" id="modal-order">
  ...
  <div class="form">
    <?php echo do_shortcode('[contact-form-7 id="9643fc1" title="Order Form"]'); ?>
  </div>
</div>
